          ...
          >
            ...
            >
              <div className="px-6 py-4 bg-slate-900 border-b border-slate-800 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="text-base sm:text-lg font-bold text-white flex items-center gap-2">
                    ...
                    <span className="text-xs font-medium text-rose-400"> Demo Video Showcase</span>
                  </h3>
                </div>
                <button
                  type="button"
              ...
              {activeVideo.embedUrl !== "request" ? (
                ...
                <div className="p-8 sm:p-12 flex flex-col items-center justify-center text-center space-y-6 bg-slate-950">
                  <div className="w-16 h-16 rounded-full bg-rose-500/20 border border-rose-500/40 flex items-center justify-center text-rose-400">
                    <Play className="w-8 h-8 fill-rose-400" />
                  </div>
                  <div className="max-w-xl">
                    <h4 className="text-xl sm:text-2xl font-bold text-white mb-2">Live Demo Video Available Upon Request</h4>
                    <p className="text-slate-300 text-sm leading-relaxed">
                      We provide custom 1-on-1 video walkthroughs and live system demonstrations tailored to your business requirements for <strong>{activeVideo.project.title}</strong>.
                    </p>
                  </div>
