...
import { Database, LayoutDashboard, Workflow, Cpu, Link as LinkIcon, BarChart, Server, ShieldCheck, Code, Globe } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-7">
          {servicesList.map((service: any, index: number) => {
            ...
            const tags = (service.features && service.features.length > 0)
              ...
              : (serviceTags[service.id] || ["Reliable", "Scalable", "Custom"]);
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <div className="relative z-10 pt-4 border-t border-brand-border/60 flex items-center justify-between text-xs font-bold text-brand-text-muted group-hover:text-brand-cyan transition-colors duration-200 mt-auto">
