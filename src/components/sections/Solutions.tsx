...
function SolutionCard({ solution, index }: { solution: any; index: number }) {
  ...
  return (
    <motion.div
      ...
      className="h-full"
    >
      <div className="relative overflow-hidden flex flex-col items-center text-center justify-between h-full p-6 sm:p-7 rounded-2xl bg-brand-card border border-brand-border/80 shadow-xs hover:shadow-[0_24px_50px_-10px_rgba(0,77,64,0.32),0_12px_24px_-6px_rgba(0,77,64,0.18)] hover:border-[#004D40] hover:-translate-y-1.5 hover:bg-[#DDF4F0] transition-all duration-300 group">
        
        {/* Centered IT Icon */}
        <div className="w-16 h-16 rounded-2xl flex items-center justify-center bg-white/95 border border-[#004D40]/25 text-[#004D40] mb-3.5 shadow-2xs group-hover:scale-110 group-hover:bg-[#004D40] group-hover:text-white group-hover:shadow-md transition-all duration-300 relative z-10">
